			...
			<div role="main" class="main">
				...
				<div class="owl-carousel owl-carousel-light owl-carousel-light-init-fadeIn owl-theme manual dots-inside dots-horizontal-center show-dots-hover nav-style-diamond nav-with-transparency nav-inside nav-inside-plus nav-dark nav-md nav-font-size-md show-nav-hover mb-0" data-plugin-options="{'autoplay': false, 'autoplayTimeout': 7000}" data-dynamic-height="['700px','700px','600px','500px','410px']" style="height: 700px;">
					<div class="owl-stage-outer">
						<div class="owl-stage">
										...
										<div class="col-lg-9 col-xl-8 position-relative mx-auto mt-5 pt-5">
											<h1 class="position-relative text-color-light font-weight-bold custom-big-text-style-1 text-start text-lg-end pt-4 mt-5 appear-animation" data-appear-animation="fadeInRightShorterPlus" data-appear-animation-delay="500">
												<span class="position-absolute bottom-100 left-0 transform3dy-p50 w-100 pt-4 ms-0">
													<span class="d-inline-flex custom-outline-text-style-1 text-2 text-center appear-animation" data-appear-animation="fadeInRightShorterPlus" data-appear-animation-delay="1300">COMUNITATS</span>
												</span>
												COMUNITATS<br> FINQUES
												<span class="position-absolute top-100 left-0 transform3dy-n50 w-100 pt-4 ms-0">
													<span class="d-inline-flex custom-outline-text-style-1 text-2 text-center appear-animation" data-appear-animation="fadeInRightShorterPlus" data-appear-animation-delay="1300">FINQUES</span>
												</span>
											</h1>
										</div>
									</div>
							...
							<!-- Carousel Slide 2 -->
							<!-- <div class="owl-item position-relative" style="background-image: url(img/slides/slide-2.jpg); background-size: cover; background-position: center;">
								<div class="container position-relative z-index-1 h-100">
				...
				<div class="container py-5 my-3">
					<div class="row justify-content-between align-items-center flex-lg-nowrap gy-3">
						<div class="col-lg-4">
							<h2 class="text-color-dark font-weight-bold text-7 line-height-1 mb-3-5 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="2000">Qui Som</h2>
							<p class="text-4 font-weight-light mb-0 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="2200">A COMUNITATS.CAT ens especialitzem en l'administració de Finques i Comunitats a Lleida i Salou. Veïns de Lleida, Tàrrega, Mollerussa, Bellpuig i Salou ens confien la gestió de les seves comunitats.</p>
						</div>
				...
				<section class="section position-relative overflow-hidden border-0 m-0">
					<div class="container pt-5-5 pb-5 mb-3">
						<div class="row mb-5-5">
							<div class="col">
								<h2 class="text-color-dark font-weight-bold text-7 line-height-1 mb-3-5 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="300">Serveis</h2>
								<p class="text-4 font-weight-light appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="500">Els serveis que oferim com a administradors de finques.</p>
							</div>
						</div>
						<div class="row">
							<div class="col-md-6 mb-5 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="600">
								<div class="d-flex">
									...
									<!--<img class="flex-0-0-auto" width="60" height="60" src="img/icons/faucet.svg" alt="" data-icon data-plugin-options="{'animated': true, 'delay': 300, 'accY': 400, 'strokeBased': true, 'extraClass': 'svg-stroke-color-dark'}" /> -->
									<div class="ps-4">
										<h3 class="text-color-dark font-weight-bold text-transform-none text-5 mb-2">Control de comptes</h3>
							...
							<div class="col-md-6 mb-5 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="700">
								<div class="d-flex">
									...
									<div class="ps-3">
										<h3 class="text-color-dark font-weight-bold text-transform-none text-5 mb-2">Atenció a la comunitat 24/7</h3>
							...
							<div class="col-md-6 mb-5 mb-md-0 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="800">
								<div class="d-flex">
									...
									<div class="ps-4">
										<h3 class="text-color-dark font-weight-bold text-transform-none text-5 mb-2">Consultes, Nòmines i Assessorament Legal</h3>
							...
							<div class="col-md-6 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="900">
								<div class="d-flex">
									...
									<div class="ps-4">
										<h3 class="text-color-dark font-weight-bold text-transform-none text-5 mb-2">Rebuts, Remeses Bancàries i Cobraments</h3>
							...
							<div class="position-relative">
								...
								<div class="diamonds-wrapper">
									<ul class="diamonds mb-0">
										<li>
											<a href="img/generic/generic-1-medium.jpg" class="diamond lightbox" data-plugin-options="{'type':'image'}">
												<div class="content">
													<img src="img/generic/generic-1.jpg" class="img-fluid plugin-random-images" alt="" data-plugin-random-images data-plugin-options="{'minWindowWidth': 1200, 'random': false, 'delay': 4000, 'imagesListURL': ['img/generic/generic-4.jpg', 'img/generic/generic-3.jpg'], 'lightboxImagesListURL': ['img/generic/generic-9-medium.jpg', 'img/generic/generic-3-medium.jpg', 'img/generic/generic-1-medium.jpg'], 'animateIn': 'blurIn', 'accY': -400}" />
												</div>
											</a>
										</li>
										<li>
											<a href="img/generic/generic-2-big.jpg" class="diamond lightbox" data-plugin-options="{'type':'image'}">
												<div class="content">
													<img src="img/generic/generic-2.jpg" class="img-fluid plugin-random-images" alt="" data-plugin-random-images data-plugin-options="{'minWindowWidth': 1200, 'random': false, 'delay': 4200, 'imagesListURL': ['img/generic/generic-3.jpg', 'img/generic/generic-4.jpg'], 'lightboxImagesListURL': ['img/generic/generic-3-medium.jpg', 'img/generic/generic-9-medium.jpg', 'img/generic/generic-2-big.jpg'], 'animateIn': 'blurIn', 'accY': -400}" />
												</div>
											</a>
										</li>
										<li>
											<a href="img/generic/generic-9-medium.jpg" class="diamond lightbox" data-plugin-options="{'type':'image'}">
												<div class="content">
													<img src="img/generic/generic-4.jpg" class="img-fluid plugin-random-images" alt="" data-plugin-random-images data-plugin-options="{'minWindowWidth': 1200, 'random': false, 'delay': 4400, 'imagesListURL': ['img/generic/generic-1.jpg', 'img/generic/generic-2.jpg'], 'lightboxImagesListURL': ['img/generic/generic-1-medium.jpg', 'img/generic/generic-2-medium.jpg', 'img/generic/generic-9-medium.jpg'], 'animateIn': 'blurIn', 'accY': -400}" />
												</div>
											</a>
										</li>
										<li>
											<a href="img/generic/generic-5-wide.jpg" class="diamond diamond-sm lightbox" data-plugin-options="{'type':'image'}">
												<div class="content">
													<img src="img/generic/generic-5-small.jpg" class="img-fluid plugin-random-images" alt="" data-plugin-random-images data-plugin-options="{'minWindowWidth': 1200, 'random': false, 'delay': 4600, 'imagesListURL': ['img/generic/generic-6-small.jpg', 'img/generic/generic-10-small-diamond.jpg'], 'lightboxImagesListURL': ['img/generic/generic-6-medium.jpg', 'img/generic/generic-10-medium.jpg', 'img/generic/generic-5-wide.jpg'], 'animateIn': 'blurIn', 'accY': -400}" />
												</div>
											</a>
										</li>
										<li>
											<a href="img/generic/generic-3-medium.jpg" class="diamond lightbox" data-plugin-options="{'type':'image'}">
												<div class="content">
													<img src="img/generic/generic-3.jpg" class="img-fluid plugin-random-images" alt="" data-plugin-random-images data-plugin-options="{'minWindowWidth': 1200, 'random': false, 'delay': 4800, 'imagesListURL': ['img/generic/generic-2.jpg', 'img/generic/generic-1.jpg'], 'lightboxImagesListURL': ['img/generic/generic-2-big.jpg', 'img/generic/generic-1-medium.jpg', 'img/generic/generic-3-medium.jpg'], 'animateIn': 'blurIn', 'accY': -100}" />
												</div>
											</a>
										</li>
										<li>
											<a href="img/generic/generic-6-medium.jpg" class="diamond diamond-sm lightbox" data-plugin-options="{'type':'image'}">
												<div class="content">
													<img src="img/generic/generic-6-small.jpg" class="img-fluid plugin-random-images" alt="" data-plugin-random-images data-plugin-options="{'minWindowWidth': 1200, 'random': false, 'delay': 5000, 'imagesListURL': ['img/generic/generic-5-small.jpg', 'img/generic/generic-7-small.jpg'], 'lightboxImagesListURL': ['img/generic/generic-5-wide.jpg', 'img/generic/generic-10-medium.jpg', 'img/generic/generic-6-medium.jpg'], 'animateIn': 'blurIn', 'accY': -100}" />
												</div>
											</a>
										</li>
										<li>
											<a href="img/generic/generic-10-medium.jpg" class="diamond diamond-sm lightbox" data-plugin-options="{'type':'image'}">
												<div class="content">
													<img src="img/generic/generic-7-small.jpg" class="img-fluid plugin-random-images" alt="" data-plugin-random-images data-plugin-options="{'minWindowWidth': 1200, 'random': false, 'delay': 5200, 'imagesListURL': ['img/generic/generic-10-small-diamond.jpg', 'img/generic/generic-6-small.jpg'], 'lightboxImagesListURL': ['img/generic/generic-10-medium.jpg', 'img/generic/generic-6-medium.jpg', 'img/generic/generic-10-medium.jpg'], 'animateIn': 'blurIn', 'accY': -100}" />
												</div>
											</a>
										</li>
									</ul>
				...
				<section class="section parallax border-0 pt-5 py-0 m-0" data-plugin-parallax data-plugin-options="{'spped': '1.5', 'parallaxHeight': '125%', 'fadeIn': true}" data-image-src="img/backgrounds/background-1.jpg">
					<div class="container">
						<div class="row gy-5">
							...
							<div class="col-lg-6 align-self-center pb-lg-5 order-1 order-lg-2 ps-5 ps-lg-0">
								<div class="testimonial testimonial-style-2 testimonial-with-quotes testimonial-remove-right-quote testimonial-quotes-dark custom-testimonial-quote-position-1 mb-0">
									<blockquote>
										<p class="alternative-font-4 font-weight-medium text-start text-4 px-2 mb-0" data-plugin-animated-letters data-plugin-options="{'startDelay': 1000, 'minWindowWidth': 0, 'animationName': 'typeWriter', 'animationSpeed': 25}">Disposem d'un equip format en diferents àmbits, amb especial atenció a la part legal i comptable, enfocat a donar un servei proper i de qualitat, que ajudi al bon funcionament de la comunitat i relació entre veïns.</p>
									</blockquote>
									<div class="testimonial-author text-start ps-3 ms-1">
										<strong class="text-4-5 negative-ls-1">Anna Castanyer</strong>
										<p class="text-color-default text-start mb-0">Co-fundador de Media Comunitats</p>
									</div>
								</div>
							</div>
						</div>
				...
				<!-- COMMON-HEADER-CA -->
				<?php include "common-php/blog/ca.html"; ?>
				<!-- COMMON-HEADER-CA END -->
