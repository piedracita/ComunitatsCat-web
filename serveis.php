							...
							<div class="row gy-5">
								<div class="col-12 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="550">
									<div class="d-flex flex-column flex-sm-row align-items-center align-items-sm-start">
										...
										<!--<img class="flex-0-0-auto" width="85" height="85" src="img/icons/winch.svg" alt="" data-icon data-plugin-options="{'animated': true, 'delay': 1700, 'accY': 400, 'strokeBased': true, 'extraClass': 'svg-stroke-color-dark px-0 px-sm-5 pb-4 pb-sm-0 pt-3'}" />-->
										<div class="text-center text-sm-start">
											<h3 class="text-color-dark font-weight-bold text-transform-none text-5-5 mb-3-5">Control de comptes</h3>
